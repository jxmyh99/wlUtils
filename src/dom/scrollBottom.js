 ...
 * @LastEditors: 明月寒
 * @LastEditTime: 2019-08-13 17:29:36
 * @Description: 
 */
...
function isScrollBottom(ele){
    ...
    var eleChildrenHeigth = 0;
    if(!ele || ele === 'body'){
        scrollTop = getScrollTop
        eleChildrenHeigth = document.body.clientHeight
    }else{
        ...
        // 获取每个元素的总高度
        eleChildrenHeigth = el.childNodes[index].clientHeight
    }
    
    return ((scrollTop + winHeight)+threshold > eleChildrenHeigth)
}
